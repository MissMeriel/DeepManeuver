...
parser.add_argument('path2src', metavar='N', type=str, help='dependency parent dir')
parser.add_argument('road_id', metavar='N', type=str, help='BeamNG road i.d.')
...
def main():
    ...
    steps_per_sec = 15
    samples = 3
    newdir = "EXP2-cuton-sanitycheck-{}".format(''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(6)))
