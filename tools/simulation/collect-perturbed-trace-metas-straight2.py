...
def run_scenario_to_collect_sequence(vehicle, bng, model, spawn, cuton=40, device=torch.device('cuda')):
    ...
    writedir = "H:/GitHub/superdeepbillboard/simulation/sampledir"
...
def main():
    ...
    direction = "left"
    techniques = ["sdbb", "dbb-plus"] #[["sdbb", "dbb-orig", ] ,
    ...
    steps_per_sec = 15
    samples = 50
    newdir = "TSErev-TABLE1APPDX-noisevar-{}".format(''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(6)))
