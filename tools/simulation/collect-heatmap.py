"""
.. module:: collect_images for heatmap visualization
    :platform: Windows
...
training_dir = 'H:/BeamNG_DeepBillboard_dataset2/training_runs_{}-{}_{}samples-{}/'.format(default_scenario, spawnpoint, numsamps, collection_hash)
